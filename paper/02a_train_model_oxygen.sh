...
#SBATCH --array=5,8,9,10,11,12,13

# number of clusters and pcs
export G='5'
export pc_predictors=$SLURM_ARRAY_TASK_ID
...
export out_file=/scratch/stats_dept_root/stats_dept1/shared_data/argo/warp_entire_TSO_$SLURM_ARRAY_TASK_ID.out
...
/sw/arcts/centos7/stacks/gcc/8.2.0/R/4.1.0/bin/R CMD BATCH paper/code/data_analysis/argo_estimate_model.R $out_file
